...
bin/user-ws $LDAPURL_OPT $LDAPBINDACCT_OPT $LDAPBINDPWD_OPT $LDAPBASEDN_OPT $LDAPTLS_OPT $LDAPSKIPVERIFY_OPT $TIMEOUT_OPT $HEALTHCHECK_OPT $TOKENURL_OPT $DEBUG_OPT
